...
Como eu Vinicius Ferreira dos Santos sou aqui de São Bernardo do Campo - São Paulo . Iremos focar nossa Análise nessa região, sendo mais especifico ABCD **Vamos juntos !!!**
...
```{r Criando variavel apenas com as escolas do Municipio do ABCD }
...
```{r Plotando grafico de coluna com os dados do municipio do ABCD }
