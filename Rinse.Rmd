...
>>>>>>> cd3bb34fc9658537fb6566b56326ccb038797bd7
...
dados_SBC <- filter(Dados_SP, NO_MUNICIPIO == "São Bernardo do Campo", MEDIA_INSE <= 4.9)
```
...
ggplot(dados_SBC) +
  ...
  labs(y = "Escola", x = "Media INSE", title = "Escolas em SBC  com Média inferior a 4.9",subtitle = "Insta : @Vinifersan89 - Git : https://github.com/VFS10")
```
